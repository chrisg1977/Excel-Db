...
import { handleDepartmentManagerResolutionPreviewRequest, handleDepartmentsRequest, handleEmployeesRequest, handleLeaveAvailabilityRequest, handleLocationsRequest } from './master-data-read.js';
const app = express();
...
const describeError = (error) => {
    ...
    if (error instanceof Error) {
        ...
        if (details.length)
            return details.join(' | ');
        if (anyError.cause)
            return describeError(anyError.cause);
