...
CREATE TABLE IF NOT EXISTS employees (
    ...
    emp_id INTEGER UNIQUE NOT NULL,  -- Employee number (2018001, etc)
    ...
    -- Tax & Pay Details
    tax_status VARCHAR(50) NOT NULL,  -- SIN, PAR, PAR1, PAR2, MAR, MAR1, MAR2
    employment_type VARCHAR(20) NOT NULL,  -- FT (full-time), PT (part-time), CASUAL
    ...
    CONSTRAINT chk_emp_status CHECK (employment_status IN ('ACTIVE', 'TERMINATED', 'ON_LEAVE')),
    CONSTRAINT chk_tax_status CHECK (tax_status IN ('SIN', 'PAR', 'PAR1', 'PAR2', 'MAR', 'MAR1', 'MAR2')),
    CONSTRAINT chk_emp_type CHECK (employment_type IN ('FT', 'PT', 'CASUAL'))
);

-- ============================================================
-- 2. WAGE HISTORY (Hourly Rate Changes)
-- ============================================================
...
CREATE INDEX idx_wage_history_emp_date ON wage_history(employee_id, effective_date DESC);

-- ============================================================
-- 3. STATUTORY BONUS CONFIGURATION
-- ============================================================
...
-- ============================================================
-- 4. PAYROLL ENTRIES (Monthly Container)
-- ============================================================
...
-- ============================================================
-- 5. PAYROLL LINES (Per-Employee Monthly Calculations)
-- ============================================================
...
-- ============================================================
-- 6. LEAVE BALANCES (Track VL/SL for each employee)
-- ============================================================
...
-- ============================================================
-- 8. GOVERNMENT FORMS (FS5/FS7 Storage)
-- ============================================================
...
CREATE TRIGGER trg_employees_update BEFORE UPDATE ON employees
...
-- SAMPLE DATA
-- ============================================================
-- Will add after schema validation
